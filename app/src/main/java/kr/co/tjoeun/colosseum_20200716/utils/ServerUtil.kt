...
//           몇번 주제에 대해 보고 싶은지를 화면에서 받은 topicId로 주소에 연결
...
//           몇번 주제에 대해 보고 싶은지를 화면에서 받은 replyId로 주소에 연결
...
//                    Handler 변수에 응답 처리 코드가 들어있다면 실행해주자.
        ...
        //        주제에 대한 본인 의견달기
//        토론 주제 id + 입력한 내용을 화면에서 전달 받아야 함.
